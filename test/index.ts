...
class TestBidirectional extends TestElement {
  ...
  render() {
    this.#shadowRoot.innerHTML = `
      ...
      <input data-testid="checkbox-A1" type="checkbox" data-model="checkedNames">
      <input data-testid="checkbox-A2" type="checkbox" data-model="checkedNames">

      <!-- Multiple Checkboxes (checked property added to or removed from Set) -->
      <input data-testid="checkbox-S1" type="checkbox" data-model="uniqueNames">
      <input data-testid="checkbox-S2" type="checkbox" data-model="uniqueNames">
